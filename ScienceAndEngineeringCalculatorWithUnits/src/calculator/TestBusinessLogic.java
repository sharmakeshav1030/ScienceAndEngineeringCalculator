 ...
 * 
 * <p> Copyright and Baseline Author: Lynn Robert Carter © 2017 </p>
 * 
...
public class TestBusinessLogic {
	...
	public static void main(String[] args) {
		...
		// 6. Perform setResult test
		test = new BusinessLogic();											// Set up for the test
		
		flag = test.setResult("1234560123456789");							// Perform the test
		
		System.out.println("6. Input = \"1234560123456789\"");
		...
		// 8. Perform setOperand1ErrorMessage test
		test = new BusinessLogic();											// Set up for the test
		
		test.setOperand1ErrorMessage("Test message for operand1");				// Perform the test
		
		System.out.println("8. Input = \"Test message for operand1\"");
		...
		// 9. Perform getOperand1ErrorMessage test
		test = new BusinessLogic();											// Set up for the test
		
		test.setOperand1ErrorMessage("Test message for operand1");				// Perform the test
		
		System.out.println("9. Input = \"Test message for operand1\"");
		...
		// 10. Perform setOperand2ErrorMessage test
		test = new BusinessLogic();											// Set up for the test
		
		test.setOperand2ErrorMessage("Test message for operand2");				// Perform the test
		
		System.out.println("10. Input = \"Test message for operand2\"");
		...
		// 11. Perform getOperand2ErrorMessage test
		test = new BusinessLogic();											// Set up for the test
		
		test.setOperand2ErrorMessage("Test message for operand2");				// Perform the test
		
		System.out.println("11. Input = \"Test message for operand2\"");
		...
		// 16. Perform setResultErrorMessage test
		test = new BusinessLogic();											// Set up for the test
		
		test.setResultErrorMessage("Test message for result");					// Perform the test
		
		System.out.println("16. Input = \"Test message for result\"");
		...
		if (check("\n******************\n" + 
				...
				"     operand3Defined = false\n" +
				"operand4 = 0\n" + 
				"     operand4ErrorMessage = \n" + 
				"     operand4Defined = false\n" +
				"result = 0\n" +
				"     resultErrorMessage = Test message for result\n" + 
				"resulterr = 0\n" +
				"     resulterrErrorMessage = \n" +
				"*******************\n\n", test.debugToString())) {
			numPassed++;
			System.out.println("\tPass");
		}
		...
		//17. Perform getResultErrorMessage test
		test = new BusinessLogic();											// Set up for the test
		
		test.setResultErrorMessage("Test message for result");					// Perform the test
		
		System.out.println("17. Input = \"Test message for result\"");
